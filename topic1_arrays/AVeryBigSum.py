...
Complete the aVeryBigSum function in the editor below. It must return the sum of
all array elements.
...
range. You might need to use long long int in C/C++ or long data type in Java to
store such sums.
"""

def aVeryBigSum(n, arr):
    sum = 0
    for i in range(n):
        sum += arr[i]
    return sum, type(sum)
